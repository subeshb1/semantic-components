...
export default class MenuPage extends Component {
  state = {
    active: new Array(10).fill(0)
  };
  toggle = index => {
    this.setState(({ active }) => ({
      active: active.map((v, i) => (index === i ? !v : v))
    }));
  };
      ...
      <UI.Container>
        ...
        <UI.Segment>
          <p>
            ...
            velit maiores nesciunt quam, exercitationem sapiente? Vel neque
            magni labore quisquam minus voluptatum quo rem delectus, praesentium
            eaque eius quaerat nobis?
          </p>
        </UI.Segment>
        ...
        <UI.Header>
          Menu{" "}
          <UI.Header sub as="div">
            A menu may contain another menu group in the same level as menu
            items.
          </UI.Header>
        </UI.Header>
        <UI.Menu>
