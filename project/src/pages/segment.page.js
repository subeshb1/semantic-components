    ...
    <div>
      <Container>
        ...
        <Segment state="disabled">
          ...
          officiis libero sequi! Est quae maxime laboriosam totam laudantium
          unde repudiandae consequuntur non atque. Raised Segment
        </Segment>
        ...
        <Segment padded>
          <Header as="h5">Padded</Header> Lorem ipsum dolor sit amet,
          consectetur adipisicing elit. Nemo alias repellat, aperiam saepe
          voluptate ullam quo consequatur nihil iusto aliquam vero! Ab,
          praesentium harum maiores vel amet doloribus quas ut?
        </Segment>
        <Segment padded="very">
          <Header as="h5">Very Padded</Header> Lorem ipsum dolor sit amet,
          consectetur adipisicing elit. Nemo alias repellat, aperiam saepe
          voluptate ullam quo consequatur nihil iusto aliquam vero! Ab,
          praesentium harum maiores vel amet doloribus quas ut?
        </Segment>
        ...
        <Header>Basic</Header>
        <Segment basic>
          <Header>Basic Segment</Header>Lorem ipsum dolor sit amet consectetur
          adipisicing elit. Saepe necessitatibus ad ipsum laudantium in quod
          ipsam, assumenda cumque porro consequuntur repellat distinctio
          voluptatum laborum error placeat nisi quia delectus et.
        </Segment>
      </Container>
      ...
      <Container>
        ...
        <Segment.Group horizontal>
          ...
          <Segment emphasis="tertiary">
            {" "}
            <Header>Middle</Header> Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Id temporibus nostrum magni recusandae vitae ut
            nisi quas unde doloremque maiores ea tenetur sit eveniet soluta
            tempore excepturi, totam sequi vel.
          </Segment>
          <Segment emphasis="tertiary">
            {" "}
            <Header>Right</Header> Lorem ipsum dolor sit amet, consectetur
            adipisicing elit. Fuga ipsum harum sit exercitationem pariatur
            blanditiis doloremque, molestias voluptate similique, sed quae
            asperiores. Laudantium, minus eligendi numquam temporibus
            necessitatibus sunt voluptatem!
          </Segment>
        </Segment.Group>
        ...
        <Segment.Group>
          ...
          <Segment.Group horizontal>
            <Segment emphasis="secondary">
              ...
              adipisicing elit. Ut animi quia, amet quibusdam corporis possimus
              assumenda reprehenderit, facilis exercitationem nobis et beatae.
              Mollitia necessitatibus atque excepturi possimus, suscipit
              quibusdam unde.
            </Segment>
            <Segment emphasis="tertiary">
              {" "}
