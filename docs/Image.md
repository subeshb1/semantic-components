...
<Container>
  ...
  <Image src="/img/flower2.jpg" alt="Snake" size="small" state="disabled" />
  ...
  <Image src={"/img/snake.jpg"} size="tiny" verticalAlign="top" /> <span>
    Top Aligned
  </span>
  <Divider />
  <Image src={"/img/snake.jpg"} size="tiny" verticalAlign="middle" /> <span>
    Middle Aligned
  </span>
  <Divider />
  <Image src={"/img/snake.jpg"} size="tiny" verticalAlign="bottom" /> <span>
    Bottom Aligned
  </span>
  ...
  <div class="ui segment">
    <p>
      Te eum doming eirmod, nominati pertinacia<Image
        ...
        size="mini"
        spaced
      /> argumentum ad his. Ex eam alia facete scriptorem, est autem aliquip detraxit
      at. Usu ocurreret referrentur at, cu epicurei appellantur vix. Cum ea laoreet
      recteque electram, eos choro alterum definiebas in. Vim dolorum definiebas
